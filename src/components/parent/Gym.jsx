...
import CourseImage from "../../assets/images/blog/blog6.png"
import CoachImage from "../../assets/images/blog/blog2.png"
					...
					<Col className="course-information">
						...
						<div className="course-detail">
							...
							<div className="course-description">
								<div className="course-description-A">{CourseData[1].courseList[0].courseName}</div>
								<div className="course-description-B">There are currently {CourseData[1].courseList[0].packagesAvailable} packages:</div>
								<div className="package-wrapper">
									<div>
										<div>
											<span className="package-heading">For {CourseData[1].courseList[0].packageList[0].packageName}</span>
											<br />
											{CourseData[1].courseList[0].packageList[0].price} $
											<br />
											{CourseData[1].courseList[0].packageList[0].duration} month
										</div>
										<div>
											<span className="package-heading">For {CourseData[1].courseList[0].packageList[1].packageName}</span>
											<br />
											{CourseData[1].courseList[0].packageList[1].price} $
											<br />
											{CourseData[1].courseList[0].packageList[1].duration} month
										</div>
									</div>
				...
				<Row className="gx-0">
					<Col className="trainer-wrapper">
						<div className="trainer-information">
							...
							<div>
								<span className="trainer-intro">{CourseData[1].coachList[0].coachName}</span>
								<br />
								<span className="trainer-detail">With {CourseData[1].coachList[0].yearsOfExperience} years of experience</span>
								<br />
								<span className="trainer-detail">{CourseData[1].coachList[0].describeAchievements}</span>
							</div>
						</div>
