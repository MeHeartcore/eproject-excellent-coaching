					...
					<Col className="course-information">
						...
						<div className="course-detail">
							...
							<div className="course-description">
								...
								<div className="course-description-B">There are currently {CourseData[0].courseList[0].packagesAvailable} packages:</div>
								<div className="package-wrapper">
									<div>
										<div>
											<span className="package-heading">For {CourseData[0].courseList[0].packageList[0].packageName}</span>
											<br />
										...
										<div>
											<span className="package-heading">For {CourseData[0].courseList[0].packageList[1].packageName}</span>
											<br />
				...
				<Row className="gx-0">
					<Col className="trainer-wrapper">
						<div className="trainer-information">
							...
							<div>
								<span className="trainer-intro">{CourseData[0].coachList[0].coachName}</span>
								<br />
								<span className="trainer-detail">With {CourseData[0].coachList[0].yearsOfExperience} years of experience</span>
								<br />
								<span className="trainer-detail">{CourseData[0].coachList[0].describeAchievements}</span>
							</div>
						</div>
